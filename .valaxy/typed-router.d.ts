...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/posts/how-to-compile-c-files-in-vscode/article': RouteRecordInfo<'/posts/how-to-compile-c-files-in-vscode/article', '/posts/how-to-compile-c-files-in-vscode/article', Record<never, never>, Record<never, never>>,
    '/posts/wp-Logi/article': RouteRecordInfo<'/posts/wp-Logi/article', '/posts/wp-Logi/article', Record<never, never>, Record<never, never>>,
  ...
  export interface _RouteFileInfoMap {
    ...
    'node_modules/.pnpm/valaxy@0.26.6_@babel+parser_0d2b2b4fcc81938068e0256222fd03a3/node_modules/valaxy/client/pages/[...path].vue': {
      routes: '/[...path]'
      views: never
    }
    'pages/404.md': {
    ...
    'pages/posts/how-to-compile-c-files-in-vscode/article.md': {
      routes: '/posts/how-to-compile-c-files-in-vscode/article'
      views: never
    }
    'pages/posts/wp-Logi/article.md': {
      routes: '/posts/wp-Logi/article'
      views: never
    }
    'pages/tags/index.md': {
      routes: '/tags/'
